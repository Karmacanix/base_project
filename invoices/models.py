...
class Customer(models.Model):
	trading_name = models.CharField(max_length=120, help_text="Enter the trading name of the customer", unique=True)
...
class InvoiceSettings(models.Model):
	trading_name = models.CharField(max_length=120, help_text="Your trading name", unique=True)
	...
	def get_absolute_url(self):
		return reverse('invoices:settings-detail', kwargs={'pk': self.id})
